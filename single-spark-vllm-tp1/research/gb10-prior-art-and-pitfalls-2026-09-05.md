...
- Landed AFTER our nightly, applied here as `patch/upstream-overlays/ops_ple.py`: PR #55375 (peakcrosser7, merged 09-05): fused PLE conv assumed contiguous state indices; with mamba align mode + MTP and more than one concurrent prefill, conv state lands in the wrong slot ("Theductductduct..." repetition).
